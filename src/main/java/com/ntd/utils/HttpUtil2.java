...
public class HttpUtil2 {
    ...
    public static String getByJavaNet() {
        /**
         * JDK中的URLConnection详解:
        ...
        String url = "";
        try {
            url = String.format("http://114.113.202.254:8280/broadcast/cCurrency.do/?userId=%s", URLEncoder.encode("1980626999114966373", "UTF-8"));
        } catch (UnsupportedEncodingException e1) {
            url = String.format("http://114.113.202.254:8280/broadcast/cCurrency.do/?userId=%s", "1980626999114966373");
        }
        ...
        try {
            ...
            //text/xml->xml数据 application/x-javascript->json对象 application/x-www-form-urlencoded->表单数据 application/x-java-serialized-object->java序列化对象
            conn.setRequestProperty("Content-type", "application/x-javascript");

            int code = conn.getResponseCode();//包含了getInputStream，即发送请求
            if (code == 200) {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ExecutionException {
        ...
        System.out.println(getByJavaNet());
    }
